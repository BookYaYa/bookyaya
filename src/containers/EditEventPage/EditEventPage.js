...
import { EditEventWizard, NamedRedirect, Page } from '../../components';
...
export const EditEventPageComponent = props => {
  const {
    currentUser,
...
EditEventPageComponent.defaultProps = {
...
EditEventPageComponent.propTypes = {
...
const EditEventPage = compose(withRouter, connect(mapStateToProps, mapDispatchToProps))(
  injectIntl(EditEventPageComponent)
);

EditEventPage.loadData = loadData;
